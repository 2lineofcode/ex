        ...
        [
            ...
            content: Container(
              child: VStack(
                [
                  ...
                  'isStrongPassword : ${'Aditya Pratama'.isStrongPassword}'
                      .text
                      .make(),
                ],
              ),
            ...
            content: Container(
              child: VStack(
                [
                  ...
                  'removeLetters : ${'Aditya Pratama'.removeLetters}'
                      .text
                      .make(),
                  'charCount (a): ${'Aditya Pratama'.charCount('a')}'
                      .text
                      .make(),
          ...
          ExAccordion(
            ...
            content: Container(
              child: VStack(
                [
                  'removeFirst : ${'Aditya Pratama'.removeFirst(3)}'
                      .text
                      .make(),
                  ...
                  'truncateMiddle : ${'Aditya Pratama'.truncateMiddle(4)}'
                      .text
                      .make(),
            ...
            content: Container(
              child: VStack(
                [
                  ...
                  'allBefore : ${'Aditya Pratama'.allBefore('tya')}'
                      .text
                      .make(),
                  'allBetween : ${'Aditya Pratama'.allBetween('Adi', 'tama')}'
                      .text
                      .make(),
